...
fundq_tbl      <- tbl(con, glue("read_parquet('{data_dir}/fundq-raw.parquet')"))
ccm_tbl        <- tbl(con, glue("read_parquet('{data_dir}/ccm-link.parquet')"))
stocknames_tbl <- tbl(con, glue("read_parquet('{data_dir}/crsp-stocknames.parquet')"))
